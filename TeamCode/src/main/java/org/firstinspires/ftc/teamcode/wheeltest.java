...
public class wheeltest extends OpMode
{
    ...
    public void loop() {
        ...
        motorFrontLeft.setPower(gamepad1.x? 1 : 0);
        motorBackLeft.setPower(gamepad1.a? 1 : 0);
        motorFrontRight.setPower(gamepad1.b? 1 : 0);
        motorBackRight.setPower(gamepad1.y? 1 : 0);
